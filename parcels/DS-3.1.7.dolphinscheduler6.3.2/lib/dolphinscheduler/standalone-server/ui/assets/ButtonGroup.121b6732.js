import{u as f}from"./use-rtl.d43d8217.js";import{b as p}from"./Button.3394f0e3.js";import{g as s,Q as d,f as o,i as e,h as a,d as b,m as g,a8 as m,B as h,t as $}from"./index.ccaa682a.js";const t="0!important",u="-1px!important";function i(r){return e(r+"-type",[o("& +",[s("button",{},[e(r+"-type",[a("border",{borderLeftWidth:t}),a("state-border",{left:u})])])])])}function n(r){return e(r+"-type",[o("& +",[s("button",[e(r+"-type",[a("border",{borderTopWidth:t}),a("state-border",{top:u})])])])])}const y=s("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
